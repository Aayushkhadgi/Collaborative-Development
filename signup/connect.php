...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['fullName'], $_POST['email'], $_POST['phoneNum'], $_POST['birthDate'], $_POST['address1'], $_POST['city'], $_POST['region'], $_POST['postalCode'], $_POST['extraFacilities'])) {
        ...
        $sql = "INSERT INTO Registration (fullName, email, phoneNum, birthDate, gender, address1, address2, country, city, region, postalCode, extraFacilities) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssisssssssis", $fullName, $email, $phoneNum, $birthDate, $gender, $address1, $address2, $country, $city, $region, $postalCode, $extraFacilities);
